...
const dictionary = [
...

  {
    ...
    french_word_example:
      "UNIV est une abr&#233viation de &laquouniversit&eacute&raquo.",
  },

  {
    english_word: "ABILITY",
    english_word_example:
      "He has the ability to win the match, but he must be careful.",
    french_word: "CAPACIT&#201",
    french_word_example:
      "Il a la capacit&#233 de gagner le match, mais il faut &#234tre prudent.",
  },
...

  {
    ...
    french_word: "ABSENCE",
    french_word_example:
      "Je vous entra&#238nerai en l'absence de votre entra&#238neur.",
  },

  {
    ...
    french_word_example:
      "Elle a accept&#233e de me visiter dans la semaine prochaine.",
  },

  {
    ...
    french_word_example:
      "Je n'ai pas d'acc&#232s &#224 utiliser les ordinateurs de l'&#233cole.",
  },
...

  {
    ...
    french_word_example:
      "Ma s&#156ur est une comptable d'une soci&eacutet&eacute locale.",
  },

  {
    ...
    french_word_example:
      "Elle &eacutetudait la comptabilit&eacute dans l'universit&eacute.",
  },

  {
    ...
    french_word_example:
      "Exactitude est l'une des caract&eacuteristiques d'ordinateur.",
  },

  {
    ...
    french_word_example:
      "Les informations trouv&eacutees sont vraiment exactes.",
  },

  {
    english_word: "ACCUSE",
    english_word_example:
      "We will accuse any students who have stolen our notebooks.",
    french_word: "ACCUSER",
    french_word_example:
      "Nous accuserons n'importe quels &eacutetudiants qui ont vol&eacute nos cahiers de notes.",
  },

  {
    ...
    french_word_example:
      "Je suis habitu&eacute &agrave rentrer chez moi t&ocirct.",
  },
...

  {
    ...
    french_word_example:
      "Jacques est l'acteur principal dans le film 'Titanic'.",
  },

  {
    english_word: "ACTUALLY",
    english_word_example:
      "That stone looks like a diamond. But actually, It's a normal stone.",
    french_word: "R&EacuteELLEMENT",
    french_word_example:
      "Cette pierre-l&agrave ressemble un diamant. Mais r&eacuteellement, C'est une pierre normale.",
  },
...

  {
    ...
    french_word: "AJOUTER",
    french_word_example:
      "Ajoutez un peu d'eau pour faire la nourriture d&eacutelicieuse.",
  },

  {
    ...
    french_word: "ADRESSE",
    french_word_example:
      "Dis-moi ton adresse. J'habite &agrave Kigali, Rwanda.",
  },

  {
    ...
    french_word_example:
      "Les r&eacutefugi&eacutes n'ont pas de nourriture suffisante pour vivre.",
  },

  {
    english_word: "ADJUST",
    english_word_example:
      "I've called a technician to adjust my satellite dish.",
    french_word: "R&EacuteGLER",
    french_word_example:
      "J'ai t&eacutel&eacutephon&eacute un technicien pour r&eacutegler mon antenne parabolique.",
  },

  {
    ...
    french_word: "ADMIRER",
    french_word_example:
      "Mes enfants admirent cette chorale-l&agrave. Elle chante bien.",
  },

  {
    english_word: "ADMIT",
    english_word_example:
      "He refused to admit that he has committed the crime.",
    french_word: "ADMETTRE",
    french_word_example:
      "Il a refus&eacute d'admettre qu'il a commis le crime.",
  },

  {
    english_word: "ADOLESCENT",
    english_word_example:
      "The adolescents are curious to try out everything. They have to be careful.",
    french_word: "ADOLESCENT/ADOLESCENTE",
    french_word_example:
      "Les adolescents sont curieux d'essayer presque toutes les choses. Ils doivent &ecirctre prudents.",
  },
...

  {
    ...
    french_word_example:
      "C'est une mauvaise id&#233e de voler l'argent d'autres gens.",
  },
...

  {
    ...
    french_word: "BAMBOU",
    french_word_example:
      "Nous passions &#224 travers d'une for&#234t de bambou pendant les vacances.",
  },

  {
    ...
    french_word: "BANDE",
    french_word_example:
      "J'ai mis une bande o&#249 la jambe &#233tait cass&#233e.",
  },
...

  {
    english_word: "BEAST",
    english_word_example:
      "Have you watched a movie called 'The Beauty And The Beast?' Yes, I have. It's great!",
    french_word: "B&EcircTE",
    french_word_example:
      "Avez-vous regard&eacute un film qui s'appele &laquoLa Belle Et La B&ecirc;te?&raquo D'Accord. Il est formidable!",
  },

  {
    ...
    french_word: "BATTRE",
    french_word_example:
      "Pour tuer un serpant, Il faut le battre sur la t&ecircte.",
  },
...

  {
    ...
    french_word_example:
      "Ils disent que la beaut&eacute d'une femme se trouve dans les cheveux.",
  },

  {
    ...
    french_word_example:
      "Je ne suis pas all&eacute &agrave l'&eacutecole parce que je suis malade.",
  },

  {
    english_word: "BED",
    english_word_example:
      "Never forget to always make the bed whenever you wake up.",
    french_word: "LIT",
    french_word_example:
      "N'oubliez jamais faire le lit chaque fois que tu te l&egraveves.",
  },
...

  {
    english_word: "BEFORE",
    english_word_example:
      "Before you leave, I would like to wish you a nice journey.",
    french_word: "AVANT",
    french_word_example:
      "Avant de partir, Je voudrais vous souhaite un bon voyage.",
  },
...

  {
    ...
    french_word_example:
      "Vos enfants se comportent bien &agrave l'&eacutecole.",
  },

  {
    english_word: "BEHAVIOUR",
    english_word_example:
      "The students who don't get a half marks of behaviour are expelled yearly.",
    french_word: "CONDUITE",
    french_word_example:
      "Les &eacutel&egraveves qui n'obtiennent pas une moiti&eacute des points de conduite sont renvoy&eacutes annuellement.",
  },

  {
    ...
    french_word_example:
      "Vas m'amener un b&acircton qui est derri&egravere la porte.",
  },
...

  {
    ...
    french_word: "CHOU",
    french_word_example:
      "Nous mangeons souvent des choux &agrave l'&eacutecole.",
  },
...

  {
    ...
    french_word: "BOUJIE",
    french_word_example:
      "Rappelez-moi d'ach&eacuteter des boujies au march&eacute.",
  },

  {
    ...
    french_word: "CANTINE",
    french_word_example:
      "Je bois du lait quotidiennement dans la cantine de l'universit&eacute.",
  },

  {
    english_word: "CAPABLE",
    english_word_example:
      "Placide is capable to speak english and french well.",
    french_word: "CAPABLE",
    french_word_example:
      "Placide est capable de parler l'anglais et le fran&ccedilais bien.",
  },
...

  {
    ...
    english_word_example:
      "What does the caption of the photo says? It says, 'A beatiful landscape'.",
    french_word: "SOUS-TITRE",
    french_word_example:
      "&Agrave quoi dit le sous-titre de la photo? Il dit, &laquoUn bon paysage&raquo.",
  },

  {
    ...
    french_word: "VOITURE",
    french_word_example:
      "Quand je deviendrai riche, J'ach&egraveterai une voiture.",
  },

  {
    ...
    french_word: "CARTE",
    french_word_example:
      "Demain, Nous obtenerons nos cartes d'&eacutetudiants.",
  },
...

  {
    ...
    english_word_example:
      "Be careful when you try to jumb over the fence. You might break your leg.",
    french_word: "PRUDENT/PRUDENTE",
    french_word_example:
      "Sois prudent quand tu essaie de sauter la cl&ocircture. Tu peux casser la jambe.",
  },

  {
    ...
    french_word_example:
      "Elle est n&eacutegligente pour r&eacuteviser les notes .",
  },

  {
    english_word: "CARESS",
    english_word_example:
      "Mike caresses his dog when it becomes angry, In order to calm it down.",
    french_word: "CARESSER",
    french_word_example:
      "Mike caresse son  chien quand il devient f&acircch&eacute, Pour le calmer.",
  },

  {
    english_word: "CARPENTER",
    english_word_example:
      "We need a carpenter to repair the roof of our house.",
    french_word: "CHARPENTIER",
    french_word_example:
      "Nous avons b&eacutesoin d'un charpentier pour r&eacuteparer le toit de notre maison.",
  },

  {
    english_word: "CARPENTRY",
    english_word_example:
      "You can study carpentry if you like to build with the woods.",
    french_word: "CHARPENTERIE",
    french_word_example:
      "Vous pouvez &eacutetudier la charpenterie si vous aimez b&acirctir avec les bois.",
  },
...

  {
    ...
    french_word: "CAROTTE",
    french_word_example:
      "Nous avons cultiv&eacute des carottes dans notre champ.",
  },

  {
    ...
    french_word: "PORTER",
    french_word_example:
      "Cette camion-l&agrave porte 100 sacs de pommes de terre.",
  },

  {
    english_word: "CARTOON",
    english_word_example:
      "When i was young, I liked to watch the cartoons so much. But now, I'm old and like them a little.",
    french_word: "DESSIN ANIM&Eacute",
    french_word_example:
      "Quand j'&eacutetais p&eacutetit, J'aimais regarder les dessins anim&eacutes. Mais maintenant, Je suis devenu vieux et je les aime un peu.",
  },
...

  {
    ...
    french_word_example:
      "Attrapez cet homme-l&agrave qui court. Il est voleur!",
  },

  {
    english_word: "CATEGORY",
    english_word_example:
      "What is the category of this book? It is in the category of politics.",
    french_word: "CAT&EacuteGORIE",
    french_word_example:
      "Quelle est la cat&eacutegorie de ce livre? Il est dans la categorie de politique.",
  },
...

  {
    english_word: "DEAF",
    english_word_example:
      "That oldman is deaf, He doesn't hear what you're telling him.",
    french_word: "SOURD/SOURDE",
    french_word_example:
      "Ce vieux-l&agrave est sourd, Il n'entend pas ce que vous le dis.",
  },
...

  {
    english_word: "DECIDE",
    english_word_example:
      "I have decided to stay in my native country. So, I won't go to study abroad.",
    french_word: "D&EacuteCIDER",
    french_word_example:
      "J'ai d&eacutecid&eacute de rester dans mon pays natal. Alors, Je n'irai pas &eacutetudier &agrave l'&eacutetranger.",
  },

  {
    english_word: "DECORATE",
    english_word_example:
      "They are decorating the hall in which the guests will be welcomed.",
    french_word: "D&EacuteCORER",
    french_word_example:
      "Ils d&eacutecorent la salle dans laquelle les invit&eacutes seront accueillis.",
  },

  {
    english_word: "DECREASE",
    english_word_example:
      "The music is too loud. Can you decrease the volume, Please?",
    french_word: "DIMINUER",
    french_word_example:
      "La musique est trop forte. Pouvez-vous diminuer la volume, S'il vous pla&icirct?",
  },

  {
    ...
    french_word_example:
      "Il de&eacutedie cette cahnson &agrave toi comme ton mari.",
  },

  {
    english_word: "DEDICATION",
    english_word_example:
      "My book has a dedication section in which i dedicated it to my family.",
    french_word: "D&EacuteDICACE",
    french_word_example:
      "Mon livre a une section de d&eacutedicace dans laquelle je l'ai d&eacutedi%eacute &agrave ma famille.",
  },

  {
    english_word: "DEFAULT",
    english_word_example:
      "By default, The homepage of the website has a whitebackground color. But, You can change it, Later.",
    french_word: "D&EacuteFAUT",
    french_word_example:
      "Par d&eacutefaut, La page d'accueil du site internet a une couleur blanche d'arri&egravere-plan. Mais, Vous pouvez la changer, Plus-tard.",
  },

  {
    ...
    french_word: "VAINCRE",
    french_word_example:
      "Notre &eacutequipe a vaincu la votre. Nous sommes formidables.",
  },
...

  {
    english_word: "DELETE",
    english_word_example:
      "Delete the files from the computer. They are confidential.",
    french_word: "SUPPRIMER",
    french_word_example:
      "Supprimez les fichiers de l'ordinateur. Ils sont confidentiels.",
  },

  {
    ...
    french_word_example:
      "j'aime manger des buiscuits parce qu'ils sont d&eacutelicieux.",
  },
...

  {
    ...
    english_word_example:
      "The delivery of the food is at eleven o'clock, Before noon.",
    french_word: "LIVRAISON",
    french_word_example:
      "La livraison de la nourriture est &agrave onze heures pr&eacutecise, avant-midi.",
  },

  {
    english_word: "DEMAND",
    english_word_example:
      "The employees are demanding for the increase of the salary.",
    french_word: "EXIGER",
    french_word_example:
      "Les employ&eacutes exigent l'augmentation du salaire.",
  },

  {
    english_word: "DEMOCRACY",
    english_word_example:
      "In our country, We have democracy because people elect the leaders.",
    french_word: "D&EacuteMOCRACIE",
    french_word_example:
      "Dans notre pays, Nous avons la d&eacutemocracie parce que les gens &eacutelisent des les leadeurs.",
  },
...

  {
    english_word: "EAGLE",
    english_word_example:
      "The eagles' team have bitten the lions' team and won the match.",
    french_word: "AIGLE",
    french_word_example:
      "L'&eacutequipe des aigles a battu l'&eacutequipe des lions et gagn&eacutee le match.",
  },
...

  {
    ...
    french_word: "EST",
    french_word_example:
      "Le soleil se l&egraveve de l'est et se couche &agrave l'ouest.",
  },
...

  {
    english_word: "EASY",
    english_word_example:
      "It is not easy to pass exams while you haven't revised your notes.",
    french_word: "FACILE",
    french_word_example:
      "Ce n'est pas facile de r&eacuteussir des exams tandis que vous n'avez pas r&eacutevis&eacute vos notes.",
  },
...

  {
    ...
    english_word_example:
      "You have to read books because they will facilitate your learning.",
    french_word: "FACILITER",
    french_word_example:
      "Vous devez lire des livres parce qu'ils facilitent votre apprentissage.",
  },

  {
    ...
    french_word: "USINE",
    french_word_example:
      "Mon grand-fr&egravere travaille dans une usine d'ordinateur.",
  },

  {
    english_word: "FACULTY",
    english_word_example:
      "Placide IRANDORA studies the faculty of information technology at the university of Rwanda.",
    french_word: "FACULT&Eacute",
    french_word_example:
      "Placide IRANDORA &eacutetudie la facult&eacute de technologie d'information dans l'universit&eacute du Rwanda.",
  },
...

  {
    ...
    french_word_example:
      "Beaucoup d'&eacutetudiants ont obtenu des &eacutechecs en physique.",
  },

  {
    ...
    french_word_example:
      "Nous n'avons pas ach&eacutet&eacute les diamants parce qu'ils &eacutetaient faux.",
  },

  {
    english_word: "FALL",
    english_word_example:
      "This children has fallen over the ground and got dirty.",
    french_word: "TOMBER",
    french_word_example:
      "Cet enfant est tomb&eacute sur le sol et devenu sale.",
  },
...

  {
    ...
    english_word_example:
      "She is familiarising herself with the new computer system.",
    french_word: "FAMILIARISER",
    french_word_example:
      "Elle se familiarise avec le nouveau syst&egraveme informatique.",
  },
  ...
  },
  {
    ...
    french_word_example:
      "Tom est devenu c&eacutel&egravebre &agrave l'&eacutecole.",
  },

  {
    ...
    french_word_example:
      "Vous pouvez trouver des beaux tableaux dans une gallerie.",
  },
...

  {
    ...
    french_word: "GAZ",
    french_word_example:
      "Nous utilisons une cuisini&egravere &agrave gaz chez nous.",
  },

  {
    english_word: "GENERALLY",
    english_word_example:
      "Generally, There are no problems with these products.",
    french_word: "G&EacuteN&EacuteRALLEMENT",
    french_word_example:
      "G&eacuten&eacuterallement, Il n'y a pas de probl&egravemes avec ces produits.",
  },
...

  {
    english_word: "GIRL",
    english_word_example:
      "How many girls do you have in your class? Twelve girls.",
    french_word: "FILLE",
    french_word_example:
      "Combien de filles avez-vous dans votre classe? Douze filles.",
  },

  {
    english_word: "HABIT",
    english_word_example:
      "I have a habit of waking up at 6:00 o'clock in the morning.",
    french_word: "HABITUDE",
    french_word_example:
      "J'ai une habitude de me lever &agrave 6:00 heures du matin.",
  },

  {
    english_word: "HACKER",
    english_word_example:
      "I wanted to become a computer hacker and i've become one!",
    french_word: "PIRATE INFORMATIQUE",
    french_word_example:
      "Je voulais devenir pirate informatique et je suis l'un!",
  },
...

  {
    english_word: "HAMMER",
    english_word_example:
      "Can you lend me your hammer because i want to fix a nail?",
    french_word: "MARTEAU",
    french_word_example:
      "Pouvez-vous me pr&ecircter votre marteau parce que je veux fixer un clou?",
  },
...

  {
    ...
    english_word_example:
      "Happiness is only what i need in my life, Not money.",
    french_word: "BONHEUR",
    french_word_example:
      "Le bonheur est seulement ce que je veux dans ma vie, Pas d'argent.",
  },

  {
    ...
    french_word_example:
      "Je n'aucune id&eacutee concernant comment nous pouvons nous &eacutechapper.",
  },
...

  {
    ...
    english_word_example:
      "Anyone who spreads genocide ideologies will be condemned.",
    french_word: "ID&EacuteOLOGIE",
    french_word_example:
      "N'importe quelle personne qui propage les id&eacuteologies de g&eacutenocide sera condamn&eacute.",
  },
...

  {
    ...
    french_word: "SI",
    french_word_example:
      "Si J'obtiens de l'argent, J'ach&egraveterai une maison.",
  },
...

  {
    ...
    english_word_example:
      "Hacking into other people's computer systems without their permission is illegal.",
    french_word: "ILL&EacuteGAL",
    french_word_example:
      "Le piratage des syst&egravemes informatiques d'autres gens sans leur permission est ill&eacutegal.",
  },

  {
    english_word: "ILLEGIBLE",
    english_word_example:
      "Her handwriting is illegible, I cannot read what she's writen.",
    french_word: "ILLISIBLE",
    french_word_example:
      "Sa criture est illisible, Je ne peux pas lire ce qu'elle a &eacutecrit.",
  },

  {
    ...
    french_word: "MALADIE",
    french_word_example:
      "Nous sommes en train de trouver un rem&egravede pour gu&eacuterir la maladie.",
  },

  {
    english_word: "JANUARY",
    english_word_example:
      "The New Year's party takes place on the first January.",
    french_word: "JANVIER",
    french_word_example:
      "La f&ecircte de Bonne Ann&eacutee a lieu le premier Janvier.",
  },

  {
    english_word: "JAPAN",
    english_word_example:
      "Japan is one of the developed countries of the world.",
    french_word: "JAPON",
    french_word_example:
      "Le Japon est l'un des pays d&eacutevelopp&eacutes du monde.",
  },

  {
    english_word: "JEALOUS",
    english_word_example:
      "My young sister has become jealous because of my new dress.",
    french_word: "JALOUX/JALOUSE",
    french_word_example:
      "Ma p&eacutetite-s&#156ur est devenue jalouse &agrave cause de ma nouvelle robe.",
  },

  {
    english_word: "JESUS",
    english_word_example:
      "The chritians believe that Jesus-Christ is the son of God.",
    french_word: "J&EacuteSUS",
    french_word_example:
      "Les chr&eacutetiens croient que le J&eacutesus-Christ est le fils de Dieu.",
  },

  {
    ...
    french_word: "EMPLOI",
    french_word_example:
      "Je suis maintenant ch&ocircmeur et en train de chercher un emploi.",
  },
...

  {
    ...
    french_word_example:
      "Jacques &eacutetudiera le journalisme dans l'universit&eacute.",
  },

  {
    english_word: "JOURNALIST",
    english_word_example:
      "I met two journalists looking for information about the accident.",
    french_word: "JOURNALISTE",
    french_word_example:
      "J'ai rencontr&eacute deux journalistes cherchant des informations sur l'accident.",
  },
...

  {
    english_word: "KICK",
    english_word_example:
      "The policeman gave the thief a kick when he tried to escape.",
    french_word: "COUP DE PIED",
    french_word_example:
      "Le policier donnait un coup de pied au voleur quand il essayait de s'&eacutechapper.",
  },

  {
    english_word: "KILL",
    english_word_example:
      "The president has been killed by an unidentified person.",
    french_word: "TUER",
    french_word_example:
      "Le pr&eacutesident a &eacutet&eacute tu&eacute par une personne non-identifi&eacutee.",
  },
...

  {
    ...
    french_word: "CUISINE",
    french_word_example:
      "Ma s&#156ur est en train de faire la cuisine dans la cuisine.",
  },
...

  {
    english_word: "LADY",
    english_word_example:
      "Good morning lady! Would you like any help about fixing that?",
    french_word: "MADEMOISELLE",
    french_word_example:
      "Bon avant-midi mademoiselle! Voudriez-vous une aide sur fixant &ccedila?",
  },
...

  {
    ...
    french_word: "LANGUE",
    french_word_example:
      "Quelles langues parlez-vous? Anglais et Fran&ccedilais.",
  },

  {
    ...
    french_word_example:
      "Mon oncle a ach&eacutet&eacute pour moi un nouveau ordianteur portable.",
  },
...

  {
    ...
    english_word_example:
      "In a factory, There are machines wich perform different tasks.",
    french_word: "MACHINE",
    french_word_example:
      "Dans une usine, Il y a des machines qui font des t&acircches diff&eacuterentes.",
  },

  {
    ...
    french_word_example:
      "Je pense que tu es folle de marcher dans cette pluie.",
  },

  {
    ...
    french_word: "MAGIE",
    french_word_example:
      "Ceux qui pratiquent la magie seront emprisonn&eacute.",
  },
...

  {
    ...
    french_word: "HOMME",
    french_word_example:
      "Je connais cet homme. Nous nous rencontrions quelque part.",
  },

  {
    ...
    french_word: "MANGUE",
    french_word_example:
      "Elle a ach&eacutet&eacute ces mangues dans le march&eacute.",
  },

  {
    ...
    french_word_example:
      "Les enseignants savent comment manipuler leurs &eacutel&egraveves.",
  },

  {
    ...
    french_word_example:
      "Nous avons b&eacutesoin de main-d'&#156vre pour le nouveau d&eacutepartement.",
  },
...

  {
    ...
    french_word_example:
      "Quelle est votre nationalit&eacute? Je suis Rwandaise.",
  },
...

  {
    ...
    french_word_example:
      "Il est n&eacutecessaire de boire assez d'eau tous les jours.",
  },

  {
    ...
    french_word: "BESOIN",
    french_word_example:
      "Mes camarades de classe ont besoin de plus d'argent pour ach&eacuteter cahiers de notes.",
  },
...

  {
    ...
    french_word_example:
      "L'oc&eacutean Pacifique est le plus grand oc&eacutean dans le monde.",
  },

  {
    english_word: "OCTOBER",
    english_word_example:
      "I started to study at the university of Rwanda in the month of October.",
    french_word: "OCTOBRE",
    french_word_example:
      "Je commen&ccedilais &eacutetudier dans l'universit&eacute du Rwanda au mois d'Octobre.",
  },

  {
    english_word: "OFFICE",
    english_word_example:
      "The manager is busy preparing reports in his office.",
    french_word: "BUREAU",
    french_word_example:
      "Le g&eacuterant est occup&eacute dans son bureau pr&eacuteparant des rapports.",
  },

  {
    english_word: "OFFICIAL",
    english_word_example:
      "The official announcement from the government says to not smoke in public places.",
    french_word: "OFFICIEL/OFFICIELLE",
    french_word_example:
      "L'annonce officielle du gouvernement dit de ne pas f&ucircmer dans les endroits publics.",
  },

  {
    ...
    french_word: "SOUVENT",
    french_word_example:
      "Comment souvent allez-vous au march&eacute? Deux fois dans la semaine.",
  },

  {
    ...
    french_word: "HUILLE",
    french_word_example:
      "Il est all&eacute ach&eacuteter de l'huille de cuisine aux magasins.",
  },
...

  {
    english_word: "PACKET",
    english_word_example:
      "There remains two packets of biscuits in the cupboard.",
    french_word: "PAQUET",
...

  {
    ...
    french_word: "CADENAS",
    french_word_example:
      "Voil&agrave la cl&eacute qui ouvre le cadenas du portail.",
  },
...

  {
    ...
    english_word_example:
      "I have bought a paintbrush to paint the room, tomorrow.",
    french_word: "PINCEAU",
    french_word_example:
      "J'ai ach&eacutet&eacute un pinceau pour paindre la pi&egravece, demain.",
  },
...

  {
    ...
    french_word: "PAPIER",
    french_word_example:
      "Prenez un merceau de papier et &eacutecrivez votre nom sur le.",
  },

  {
    english_word: "PARADE",
    english_word_example:
      "At school, We were taught how to march on the parade.",
    french_word: "D&EacuteFIL&Eacute",
    french_word_example:
      "&Agrave l'&eacutecole, Nous nous &eacutetions enseign&eacutes comment marcher sur le d&eacutefil&eacute.",
  },

  {
    ...
    french_word_example:
      "La qualit&eacute de l'&eacuteducation est tr&egraves importante.",
  },

  {
    ...
    french_word_example:
      "Le Qu&eacutebec se trouve dans le continent d'Am&eacuterique.",
  },
...

  {
    ...
    english_word_example:
      "The children ask too many questions beacuse they are curious.",
    french_word: "QUESTION",
    french_word_example:
      "Les enfants posent trop de questions parce qu'ils sont curieux.",
  },

  {
    english_word: "QUESTIONNAIRE",
    english_word_example:
      "There are twelve questions on the questionnaire that you must answer.",
    french_word: "QUESTIONNAIRE",
    french_word_example:
      "Il y a douze questions sur le questionnaire que vous devez r&eacutepondre.",
  },

  {
    english_word: "QUEUE",
    english_word_example:
      "We had to form a queue to be able to enter into the stadium.",
    french_word: "QUEUE",
    french_word_example:
      "Nous devions former une queue pour &ecirctre capable d'entrer dans le stade.",
  },
...

  {
    ...
    english_word_example:
      "Go quickly so that you won't be late to arrive at work.",
    french_word: "VITE",
    french_word_example:
      "Allez vite pour que vous ne serez pas en retard d'arriver au travail.",
  },
...

  {
    ...
    english_word_example:
      "We entered into the class quietly because we were late.",
    french_word: "TRANQUILLEMENT",
    french_word_example:
      "Nous entrions tranquillement dans la classe parce que nous &eacutetions en retard.",
  },
...

  {
    english_word: "RACE",
    english_word_example:
      "Augustin's father was the winner of the race, yesterday.",
    french_word: "COURSE",
    french_word_example:
      "Le p&egravere d'Augustin a &eacutet&eacute le gagnant de la course, hier.",
  },
...

  {
    ...
    english_word_example:
      "The government of Rwanda planned to construct the railroad for train transport.",
    french_word: "CHEMIN DE FER",
    french_word_example:
      "Le gouvernement du Rwanda planifait de construire le chemin de fer pour le transport de train.",
  },

  {
    english_word: "RAISE",
    english_word_example:
      "Raise up your hand if you want to answer the question.",
    french_word: "LEVER",
    french_word_example:
      "Levez la main si vous voulez r&eacutepondre &agrave la question.",
  },

  {
    english_word: "RAKE",
    english_word_example:
      "We can use a rake to put the soil on the same level.",
    french_word: "R&AcircTEAU",
    french_word_example:
      "Nous pouvons utiliser un r&acircteau pour mettre le sol au m&ecircme niveau.",
  },

  {
    english_word: "RANSOM",
    english_word_example:
      "You must pay a ransom to get back your grand-father.",
    french_word: "RAN&CcedilON",
    french_word_example:
      "Vous devez payer une ran&ccedilon pour obtenir de nouveau votre grand-p&egravere.",
  },

  {
    english_word: "RAPE",
    english_word_example:
      "The police have finally caught the man who was trying to rape a lady.",
    french_word: "VIOLER",
    french_word_example:
      "La police a finallement attrap&eacute l'homme qui essayait de violer une dame.",
  },
...

  {
    ...
    french_word: "TRISTE",
    french_word_example:
      "Pourquoi tu es triste? J'ai &eacutechou&eacute. D&eacutesol&eacute.",
  },

  {
    ...
    french_word_example:
      "Votre argent est en s&eacutecurit&eacute dans la banque, maintenant.",
  },

  {
    english_word: "SAFETY",
    english_word_example:
      "We didn't have safety there. That's why we moved house.",
    french_word: "S&EacuteCURIT&Eacute",
    french_word_example:
      "Nous n'avions pas de s&eacutecurit&eacute l&agrave. C'est pourquoi, nous d&eacutem&eacutenagions.",
  },

  {
    english_word: "SALARY",
    english_word_example:
      "The salary of the employees in our organization is good.",
    french_word: "SALAIRE",
    french_word_example:
      "Le salaire des employ&eacutes dans notre organisation est bon.",
  },
...

  {
    ...
    french_word_example:
      "Les satellites nous aident pour communiquer dans partout le monde.",
  },
...

  {
    ...
    french_word_example:
      "Tu dois boire tous ces comprim&eacutes pour &ecirctre gueri.",
  },

  {
    english_word: "TABOO",
    english_word_example:
      "It's a taboo for a girl to be the first person to propose a boy in Rwanda.",
    french_word: "TABOU",
    french_word_example:
      "C'est un tabou au Rwanda, quand une fille est la premi&egravere personne pour demander un gar&ccedilon en mariage.",
  },

  {
    english_word: "TAIL",
    english_word_example:
      "Don't touch the tail of the dog. If you do, It will bite you.",
    french_word: "QUEUE",
    french_word_example:
      "Ne touche pas la queue du chien. Si tu le fait, Il te mordra.",
  },

  {
    english_word: "TAILOR",
    english_word_example:
      "I'm going to see if the tailor has finished mending my clothes.",
    french_word: "TAILLEUR",
    french_word_example:
      "Je vais voir si le tailleur a fini raccommoder mes v&ecirctements.",
  },
...

  {
    english_word: "TATTOO",
    english_word_example:
      "Many famous singers of hip hop have tattoos on their bodies.",
    french_word: "TATOUAGE",
    french_word_example:
      "Beaucoup de chanteurs c&eacutel&egravebres de hip hop ont des tatouages sur leurs corps.",
  },

  {
    english_word: "TAX",
    english_word_example:
      "Anyone who does business must pay tax to the government.",
    french_word: "TAXE",
    french_word_example:
      "Quiconque qui fait l'affaire doit payer la taxe au gouvernement.",
  },
  {
    english_word: "TAXI",
    ...
    french_word: "TAXI",
    french_word_example:
      "J'ai pris un taxi de l'a&eacuteroport jusqu'&agrave la maison.",
  },

  {
    english_word: "UK",
    english_word_example:
      "I've got a scholarship to study in the United Kingdom.",
    french_word: "ROYAUME-UNI",
    french_word_example:
      "J'ai obtenu une bourse d'&eacutetudier au Royaume-Uni.",
  },

  {
    english_word: "UMBRELLA",
    english_word_example:
      "The rain has made me wet because i've forgotten to take an umbrella with me.",
    french_word: "PARAPLUIE",
    french_word_example:
      "La pluie m'a fait mouill&eacute parce que j'ai oubli&eacute amener une parapluie avec moi.",
  },

  {
    english_word: "UNABLE",
    english_word_example:
      "Alice is unable to go quickly beacuse she's broken her leg.",
    french_word: "INCAPABLE",
    french_word_example:
      "Alice est incapable d'aller vite parce qu'elle a cass&eacute la jambe.",
  },
...

  {
    ...
    english_word_example:
      "Unauthorized access to other people's computers is illegal.",
    french_word: "NON AUTORIS&Eacute",
    french_word_example:
      "Acc&egraves non autoris&eacute aux ordinateurs d'autres gens est ill&eacutegal.",
  },

  {
    english_word: "UNAVAILABLE",
    english_word_example:
      "The electricity is currently unavailable at home. It has gone.",
    french_word: "INDISPONIBLE",
    french_word_example:
      "L'&eacutelectricit&eacute est actuellement indisponible chez nous. Elle est partie.",
  },
...

  {
    ...
    french_word: "VALIDER",
    french_word_example:
      "Votre passeport est expir&eacute. Vous devez le valider.",
  },
...

  {
    english_word: "VALUE",
    english_word_example:
      "My computer laptop has a value of four hundred thousand Rwandan francs.",
    french_word: "VALEUR",
    french_word_example:
      "Mon ordinateur portable a la valeur de quatre cents milles francs Rwandais.",
  },

  {
    english_word: "VEGETABLE",
    english_word_example:
      "The Cabbages and tomatoes are examples of vegetables.",
    french_word: "L&EacuteGUME",
    french_word_example:
      "Les choux et les tomates sont des examples de l&eacutegumes..",
  },

  {
    english_word: "VEHICLE",
    english_word_example:
      "Cars and motorbikes are the most popular vehicles in Rwanda.",
    french_word: "V&EacuteHICULE",
    french_word_example:
      "Les voitures et les motos sont les v&eacutehicules les plus populaires au Rwanda.",
  },

  {
    ...
    french_word_example:
      "Ma m&egravere est veg&eacutetarienne. Elle ne mange pas de viande.",
  },

  {
    english_word: "VENOM",
    english_word_example:
      "Snakes have the powerful venom which can kill humans quickly.",
    french_word: "VENIN",
    french_word_example:
      "Les serpents ont le venin puissant qui peut tuer les humains rapidement.",
  },

  {
    english_word: "VERB",
    english_word_example:
      "Verb shows an action in a sentence. I am writing now!",
    french_word: "VERBE",
    french_word_example:
      "Le verbe montre une action dans une phrase. J'&eacutecris maintenant!",
  },

  {
    english_word: "VERIFY",
    english_word_example:
      "I would like to verify that the door is really closed.",
    french_word: "V&EacuteRIFIER",
    french_word_example:
      "Je voudrais v&eacuterifier que la porte est vraiment ferm&eacutee.",
  },
...

  {
    ...
    french_word_example:
      "La serveuse m'a amen&eacute une bouteille froide de bi&egravere.",
  },

  {
    english_word: "WAKE",
    english_word_example:
      "Wake the children up. It's time to prepare them to go to school.",
    french_word: "R&EacuteVEILLER",
    french_word_example:
      "R&eacuteveillez les enfants. C'est le temps de les pr&eacuteparer pour aller &agrave l'&eacutecole.",
  },
...

  {
    english_word: "WALL",
    english_word_example:
      "The wall has been broken by the car which made the accident.",
    french_word: "MUR",
    french_word_example:
      "Le mur a &eacutet&eacute cass&eacute par la voiture qui a fait l'accident.",
  },
...

  {
    ...
    french_word: "VOULOIR",
    french_word_example:
      "Je veux voyager &agrave l'&eacutetranger aux &Eacutetats-Unis.",
  },

  {
    english_word: "WAR",
    english_word_example:
      "There are many refugees in the camp who are escaping the war from their country.",
    french_word: "GUERRE",
    french_word_example:
      "Il y a beaucoup de r&eacutefugi&eacutes dans le camp qui s'&eacutechappent la guerre de leur pays.",
  },

  {
    ...
    french_word_example:
      "Ma s&#156ur a trop de v&ecirctement dans sa garde-robe.",
  },
...

  {
    english_word: "YEAR",
    english_word_example:
      "Our academic year now starts in October, Not in September like before.",
    french_word: "ANN&EacuteE",
    french_word_example:
      "Notre ann&eacutee scolaire commence en Octobre, Pas en Septembre comme autrefois.",
  },

  {
    english_word: "YELLOW",
    english_word_example:
      "Bananas which are already to be eaten are turned into yellow.",
    french_word: "JAUNE",
    french_word_example:
      "Les bananes qui sont pr&ecirctes &agrave &ecirctre mang&eacutees sont devenues jaune.",
  },
...

  {
    ...
    english_word_example:
      "Our mother has bought two yoghurts for us, As her children!",
    french_word: "YAOURT",
    french_word_example:
      "Notre m&egravere nous a ach&eacutet&eacute deux yaourt, Comme ses enfants!",
  },

  {
    ...
    french_word: "JEUNE",
    french_word_example:
      "Nous sommes encore jeunes et nous acheverons beaucoup de choses.",
  },
...

  {
    ...
    french_word_example:
      "Nous sommes all&eacutes au parc national pour voir les z&egravebres.",
  },

  {
    english_word: "ZERO",
    english_word_example:
      "I don't want you to get zero in the test. So, You have to revise your notes.",
    french_word: "Z&EacuteRO",
    french_word_example:
      "Je ne veux pas que tu auras z&eacutero dans l'interrogation. Alors, tu dois r&eacuteviser tes notes.",
  },
];
